  ...
  <el-card class="user-container">
    ...
    <div class="user-profile">
      <div class="box-center">
        <PanThumb :image="$store.getters.userInfo.avatar" height="100px" width="100px">
          <div>hello</div>
          {{ $store.getters.userInfo.title }}
        </PanThumb>
      </div>
      <div class="box-center">
        <div class="user-name text-center">{{ $store.getters.userInfo.username }}</div>
        <div class="user-role text-center text-muted">{{ $store.getters.userInfo.title }}</div>
      </div>
    </div>
